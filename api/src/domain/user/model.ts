...
import { ErrorApi } from "../../services/errorHandling/errorHandler.js";
//~ Security
import {
  generateAccessToken,
  generateRefreshToken,
} from "../../services/jsonWebToken.js";
...
class UserModel extends CoreModel {
  ...
  controlUpdatedUserDetails = async (
    req: Request,
    res: Response,
    userId: number
  ) => {
  ...
  controlDeletedUserDetails = async (
    req: Request,
    res: Response,
    userId: number
  ) => {
